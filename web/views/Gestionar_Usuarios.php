<?php 
define("NOMBRE_MENU", "Gestionar_Usuarios.php");
...
>
  ...
  <body>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="row">
                ...
                <div class="col-lg-12">
                  <div class="alert alert-primary" role="alert">Gestionar Usuarios</div>
                </div>

                <div class="col-md-12 col-lg-12 col-xl-12 order-0 mb-12">
                  <div class="card">
                  <h5 class="card-header">Usuarios Registrados</h5>
                    <div id="table_gestionar_usuarios"></div>
                  </div>
                </div>
              </div>
            </div>
    ...
    <script src="../assets/js/Gestionar_Usuarios.js?v=<?php echo(rand()); ?>"></script>
  </body>
</html>
