<?php 
define("NOMBRE_MENU", "Notificaciones_Temp.php");
...
>
  ...
  <body>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="row">
                ...
                <div class="col-lg-12">
                  <div class="alert alert-primary" role="alert">Notificaciones</div>
                </div>

                <div class="col-md-12 col-lg-12 col-xl-12 order-0 mb-12">
                  <div class="card">
                  <h5 class="card-header">Alertas Generadas </h5>
                    <div id="table_alertas_Generadas"></div>
                  </div>
                </div>
    ...
    <script src="../assets/js/Notificaciones_Temp.js?v=<?php echo(rand()); ?>"></script>
  </body>
</html>
